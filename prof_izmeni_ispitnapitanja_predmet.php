...
<?php
    ...
    if ($result !== false && mysqli_num_rows($result) > 0)
    {
        while ($row = mysqli_fetch_assoc($result))
        {
            ...
            echo "<p><a href='".$row['fajlputanja']."' target='_blank'>".$row['naslov']."</a> | ".$row['datum_objave']." | Autor: ".$autor_ime." <a href='prof_izmeni_ispitnapitanja_predmet.php?obrisi=1&id=".$row['id_materijal']."'>Obrisi</a></p>";
        }
    }
    ...
    if (isset($_GET['obrisi']) && $_GET['obrisi'] == 1)
    {
        ...
        header("Location:prof_izmeni_ispitnapitanja_predmet.php?sifra=".$_GET['sifra']);
    }
